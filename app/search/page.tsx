...
async function SearchPage({searchParams}: Props) {
    console.log("SearchPage: searchParams received >>>", searchParams);// debugg

    if(!searchParams.url){
        console.log("SearchPage: searchParams.url is missing!");//debugg
        return notFound();
    } 

    const results = await fetchResults(searchParams);

    console.log("SearchPage: fetchResults returned >>>", results);

                    ...
                    <FormField
                        ...
                        render={({field})=>(
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="Chicago, United States" {...field} />   
                                    </FormControl>
                                </FormItem>
                            )}
                        />
                                            ...
                                            <PopoverTrigger asChild>
                                                <FormControl >
                                                    <Button
                                                        ...
                                                        )}// change the text or background to a lighter version
                                                    >
                                                        <CalendarIcon className="mr-3 h-4 w-4 opacity-50" />
                                                            {field.value?.from ?(
                                                                ...
                                                                <span className="opacity-50">Select your dates</span>
                                                        )}
                                                    </Button>
                                                </FormControl>
                                            </PopoverTrigger>
                                            <PopoverContent className="w-auto p-4 bg-white shadow-md rounded-md" align="start">
                                                <Calendar
                                                    initialFocus
                                                    mode="range"
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-col">
                                    ...
                                    <FormMessage />
                                    <FormControl>
                                        <Input type="number" placeholder="Cildren" {...field} />
                                    </FormControl>
                                </FormItem>
                            )}
                        />

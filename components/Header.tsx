...
import{ Dialog, Disclosure, PopoverGroup , Popover, Transition, PopoverButton, PopoverPanel, DialogPanel, DisclosureButton, DisclosurePanel } from "@headlessui/react";
import { 
    ChatBubbleLeftIcon,
    ChevronDownIcon,
    HomeIcon,
...
import { cn } from "@/lib/utils";
  ...
  const products = [
    ...
    {
      name: "Book a Flight",
      description: "Speack directly to your customers",
      href: "#",
...
const[mobileMenueOpen, setMobileMenuOpen] = useState(false);
  ...
  return <header className="bg-[#013B94]">
      ...
      aria-label="Global">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12"> 
          <Popover className="relative">
            ...
            <Transition
              as={Fragment}
              enter = "transiton ease-out duration-200"
            ...
            >
              ...
              <PopoverPanel className="absolute bg-white -left-8
              top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl shadow-lg ring-1 ring-gray-900/5">
    ...
    <Dialog
      as="div"
      className="lg:hidden"
      open={mobileMenueOpen}
      onClose={setMobileMenuOpen}
    >
      <div className="fixed inset-0 z-10" />

      <DialogPanel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-[#013B94] px-6 py-6 sm:max-w-sm sm:ring-1
      sm:ring-gray-900/10">
            ...
            <div className="my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                <Disclosure as="div" className="-mx-3">
                    {({ open })=> (
                      <>
                        <DisclosureButton className="flex w-full items-center justify-between rounded-lg py-2 pl-3
                        ...
                        <DisclosurePanel className ="mt-2 space-y-2">
                            {[...products,...callsToAction].map((item)=>(
                              <DisclosureButton
                                key={item.name}
                                as="a"
                                href={item.href}// why is item.href not showing up here?
